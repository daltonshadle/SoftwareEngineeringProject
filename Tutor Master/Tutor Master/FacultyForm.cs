        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (INBOX)
                {
                    ...
                    if (lvMessages.SelectedItems[0].SubItems[3].Text == "False")
                    {
                        ...
                        db.sendMessage(user, inboxMessageList[currentIndex].getFromUser(), "Tutor Request Approved", user + " has approved you to tutor " + inboxMessageList[currentIndex].getCourseName(), true, DateTime.Now);
                        lvMessages.SelectedItems[0].SubItems[3].Text = "True";
                        rtbMessageDetails.Clear();
            ...
            else
            {
                if (INBOX)
                {
                    ...
                    if (lvMessages.SelectedItems[0].SubItems[3].Text == "False")
                    {
                        ...
                        db.sendMessage(user, inboxMessageList[currentIndex].getFromUser(), "Tutor Request REJECTED", user + " has not approved you to tutor " + inboxMessageList[currentIndex].getCourseName(), true, DateTime.Now);
                        lvMessages.SelectedItems[0].SubItems[3].Text = "True";
                        rtbMessageDetails.Clear();
                        rtbMessageDetails.AppendText("Done");
                    }                   
